...
// it was just defined here. Not functional... Abstract class
...
class AuthFirebaseServiceImpl extends AuthFirebaseService {
  ...
  Future<Either> signin(SigninUserReq signinUserReq) async {
    try {
      print(signinUserReq.email);
      print(signinUserReq.password);
  ...
  Future<Either> signup(CreateUserReq createUserReq) async {
    try {
      print(createUserReq.email);
      print(createUserReq.password);
